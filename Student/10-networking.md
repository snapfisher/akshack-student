...
1. Your first task is to add a dns label to your __content-web__ service. _(Hint: make sure to review the Learning Resources for this challenge!)_
...
## Part 2a: Create an Ingress Controller
...
2. Create an nginx ingress controller. (Hint: use the helm method)
...
1. Your first challenge is to determine how to add a dns label to the ingress controller that you deployed using helm. _Read the Learning Resources!_ Note the following:
